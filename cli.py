...
# Cloudflare yashirin URL manzilingiz
URL = "https://olympic-example-interviews-promoted.trycloudflare.com"

# Terminal uchun ranglar (chiroyli ko'rinish uchun)
COLOR_GREEN = '\033[92m'
COLOR_BLUE = '\033[94m'
    ...
    while True:
        try:
            ...
            if response.status_code == 200:
                try:
                    # Serverdan kelgan JSON ni o'qish (biz serverda shunday yozgan edik)
                    data = response.json()
                    ...
                    # Agar JSON emas, oddiy matn kelsa
                    print(f"\n{COLOR_GREEN}🤖 MedAI:{COLOR_RESET}\n{response.text}\n")
            else:
            ...
            # Ctrl+C bosilganda chiroyli chiqib ketish
            print("\nDasur to'xtatildi.")
            sys.exit(0)
